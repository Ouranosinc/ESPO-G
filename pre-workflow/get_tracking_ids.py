...
if __name__ == "__main__":
    ...
    # remove duplicates
    tracking_ids = {k: list(set(v)) for k, v in tracking_ids.items()}

with open(
    f"{CONFIG['paths']['final']}/inputchecks/input_tracking_ids.json", "w", encoding="utf-8"
) as file:
    json.dump(tracking_ids, file, indent=4)
