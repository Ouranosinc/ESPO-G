...
<p>et faire</p>
<pre><code>$ dot -Tpng  -Gdpi=600 -Gratio=fill dag.dot -o dag.png  
</code></pre>
<p><strong>-Tpng</strong>: spécifie que la sortie doit être au format PNG. On peut remplacer png par svg ou pdf.<br>
<strong>-Gratio</strong>:ajuste le ratio de l’image pour remplir l’espace disponible.<br>
<strong>-Gdpi=600</strong>: définit la résolution de l’image à 600 DPI (dots per inch), ce qui augmente la qualité et la taille de l’image.</p>
