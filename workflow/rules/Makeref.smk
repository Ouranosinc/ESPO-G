...
# rule ref_default:
#     output:
#         directory(finaldir/"reference/{ref_source}+{dom}+{region}+default.zarr.zip")
#     params:
#         n_workers=2,
#         mem='50GB',
#         cpus_per_task=10,
...
#     input:
#         finaldir/"reference/{ref_source}+{dom}+{region}+default.zarr.zip"
#     output:
#         directory(finaldir/"reference/{ref_source}+{dom}+{region}+{calendar}.zarr.zip")
#     params:
#         n_workers=2,
#         mem='50GB',
#         cpus_per_task=10,
