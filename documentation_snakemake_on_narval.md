...
```
## Common.smk
Le fichier *common.smk* permet de définir des fonctions qui seront utiliser par les autres fichiers .smk ce qui permet de ne pas trop les surcharger avec du code. C'est pour dans cette règle
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDI3MTU1NjEsLTEwMzAyMzI3Niw5NT
