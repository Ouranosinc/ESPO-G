...
Le fichier  *Snakefile*  est essentiel dans Snakemake. Il permet de définir les différentes étapes de traitement des données sous forme de règles.  Chaque règle spécifie les fichiers d’entrée, les fichiers de sortie et les commandes à exécuter pour transformer les entrées en sorties
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NTU2MzcwMCwzNTMyMTk1NzgsLTM2OT
